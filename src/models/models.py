...
class Exercise(db.Model):
    ...
    workouts = db.relationship('Workout', secondary='workouts_exercises', viewonly=True)
...
class Workout(db.Model):
    ...
    exercises = db.relationship('Exercise', secondary='workouts_exercises', viewonly=True)
